...
personList.append(
    Person("Zucker Zahn", "dentist", "If you drink from the fountain of knowledge, quench your thirst slowly."))
...
print()
"Sort the personList in place by job ..."
...
print()
"Show the quote(s) from any dentist:"
look = 'dentist'
for person in personList:
